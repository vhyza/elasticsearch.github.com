...
| @minimum_should_match@ | A value controlling how many "should" clauses in the resulting boolean query should match. It can be an absolute value (@2@), a percent value (@30%@) or "combinations of both":/guide/reference/query-dsl/minimum-should-match.html. |
