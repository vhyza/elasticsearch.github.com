...
The number of terms which should match can be controlled with the @minimum_should_match@, @low_freq_operator@ (default @"or"@) and @high_freq_operator@ (default @"or"@) parameters. 
