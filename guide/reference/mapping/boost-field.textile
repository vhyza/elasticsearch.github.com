...
p. The above mapping defines mapping for a field named @my_boost@. If the @my_boost@ field exists within the JSON document indexed, its value will control the boost level of the document indexed. For example, the following JSON document will be indexed with a boost value of @2.2@:
