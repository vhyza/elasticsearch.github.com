...
p. The @update@ action payload, supports the following options: @doc@ (partial document), @upsert@, @doc_as_upsert@, @script@, @params@ (for script), @lang@ (for script). See update documentation for details on the options. Curl example with update actions:
