...
p. Since version @0.90.1@ there is a new rest end point that allows the source to be returned directly without any additional content around it. The get endpoint has the followig structure: @{index}/{type}/{id}/_source@
...
p. Note, there is also a HEAD variant for the new _source endpoint.
