...
* @cluster.routing.allocation.balance.shard@: defines the weight factor for shards allocated on a node (float). Defaults to @0.45f@.
...
* @cluster.routing.allocation.balance.primary@: defines a weight factor for the number of primaries of a specific index allocated on a node (float). @0.05f@.
* @cluster.routing.allocation.balance.threshold@: minimal optimization value of operations that should be performed (non negative float). Defaults to @1.0f@.
