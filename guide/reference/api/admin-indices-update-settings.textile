...
|@index.index_concurrency@|Default to @8@.|
|@index.codec@|Codec. Default to @default@.|
...
|@index.gateway.snapshot_interval@|The gateway snapshot interval (only applies to shared gateways). Default to 10s.|
...
|@index.routing.allocation.disable_allocation@|Disable allocation. Defaults to @false@.|
|@index.routing.allocation.disable_new_allocation@|Disable new allocation. Defaults to @false@.|
|@index.routing.allocation.disable_replica_allocation@|Disable replica allocation. Defaults to @false@.|
...
|"store level throttling":/guide/reference/index-modules/store/|All the settings for the store level throttling policy currently configured.|
|@index.translog.fs.type@|Either @simple@ or @buffered@ (default).|
|@index.compound_format@|See "index settings":/guide/reference/index-modules/|
|"slowlog":/guide/reference/index-modules/slowlog/|All the settings for slow log.|
|@index.warmer.enabled@|See "admin indices warmers":/guide/reference/api/admin-indices-warmers/. Default to @true@.|
