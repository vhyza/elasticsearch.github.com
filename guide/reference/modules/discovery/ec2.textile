...
p. You'll need to install the @cloud-aws@ plugin. Please check the <a href="https://github.com/elasticsearch/elasticsearch-cloud-aws">plugin website</a> to find the most up-to-date version to install before (re)starting elasticsearch.
