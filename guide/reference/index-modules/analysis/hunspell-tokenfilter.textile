...
* @recursionLevel@ (since 0.90.3) - Configures the recursion level a stemmer can go into. Defaults to @2@. Some languages (for example czech) give better results when set to @1@ or @0@, so you should test it out.
