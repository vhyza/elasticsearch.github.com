...
p. All analyzers, tokenizers, and token filters can be configured with a @version@ parameter to control which Lucene version behavior they should use. Possible values are: @3.0@ - @3.6@, @4.0@ - @4.3@ (the highest version number is the default option).
